...
$router->group(['prefix' => 'api/{domain}', 'middleware' => ['validate.domain']], function () use ($router) {
    ...
    $router->get('cursos/docente/{docenteId}', 'CursoController@getCursosDocente');
    ...
    $router->get('unidades/{domain_id}/{carrera_id}/{estado_id}', 'CursoController@getTotalCreditsByCurso');
